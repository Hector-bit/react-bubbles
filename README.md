...
- [ ] Explain what a token is used for.
      ...
      A token is used for logining in users by matching their credentials to a special token.

- [ ] What steps can you take in your web apps to keep your data secure?

      You can limit who has access to it.

- [ ] Describe how web servers work.

      Web servers host a site by using a IP address to talk to certain computers.

- [ ] Which HTTP methods can be mapped to the CRUD acronym that we use when interfacing with APIs/Servers.

      PUT http is used in the U of C.R.U.D. They both are used for updating information on the server.
